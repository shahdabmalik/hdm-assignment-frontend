...
const AddNewButton = () => {
    ...
    return (
        <>
            <button onClick={openModal} type="button" className="bg-blue-500 px-4 py-2 text-white rounded font-semibold hover:bg-blue-600 transition-all" >Add New</button>
                                ...
                                <Dialog.Panel className="w-full max-w-md transform rounded-md border bg-white p-5 text-left align-middle shadow-xl transition-all">
                                    <form onSubmit={handleSubmit} >
                                        <div className='flex justify-between items-center gap-5 border-b pb-1'>
                                            <h3 className='text-2xl font-bold text-slate-800 ' >Add New Lead</h3>
